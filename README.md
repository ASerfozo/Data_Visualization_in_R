...
- Task 2 Makeover Monday is the Tableau dashboards of my participation in the MakeoverMonday data viz challenge.
...
- Task 4 used car dashboard is my two paged dashboard about Ford Focus used cars from hasznaltauto.hu showing the distribution of cars across several variables and the connection of price with the attributes.
